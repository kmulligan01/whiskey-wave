...
export default {
  ...
  theme: {
    ...
    extend: {
      backgroundImage: {
        hero: "linear-gradient(to right, rgb(70, 66, 61, 0.6) 0%, rgb(39, 36, 33,0.6) 100%), url('./heroNew.jpg')",
        intro:
          "linear-gradient(to right, rgb(215, 213, 205, 0.85) 0%, rgb(244, 244, 242,0.85) 100%), url('./introBg.png')",
        cta: "linear-gradient(to right, rgb(70, 66, 61, 0.7) 0%, rgb(39, 36, 33,0.7) 100%), url('./ctaBg.jpg')",
